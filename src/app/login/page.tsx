  ...
  return (
    <div className="min-h-screen w-full flex relative">
      ...
      <div className="w-full md:w-[55%] bg-[#181C23] flex flex-col justify-center px-8 md:px-24 py-16 min-h-screen">
        ...
        <p className="text-sm text-gray-400 mb-6">Not a member? <Link href="/signup" className="text-blue-400 hover:underline">Create account</Link></p>
        <form className="space-y-4 max-w-md">
          ...
          <button type="submit" className="w-full py-2 rounded-full bg-blue-500 hover:bg-blue-600 text-white font-semibold text-base transition mt-2">Log In</button>
        </form>
      </div>
      {/* Right: Image Section */}
